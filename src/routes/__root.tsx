...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Muthu Suspension Works" },
      { property: "og:site_name", content: "Muthu Suspension Works" },
      ...
      { name: "google-site-verification", content: "58BnvnR6VBlTW91OeJC3RN-8nBlS9kD_C-XGTlhv1ac" },
    ],
    links: [
      {
        rel: "stylesheet",
